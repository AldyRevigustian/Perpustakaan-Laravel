                ...
                <h1 class="pl-[30px] pb-[2px]  border-b-[1px] border-[#e4dfdf] ">
                    ...
                    @if (session()->has('approve'))
                        <div id="hideDiv"
                            ...
                            <div>
                                <span class="font-medium">{{__('Uspješno')}}!</span> {{session('approve')}}
                            </div>
                        </div>
                    @endif
                ...
                <div class="flex flex-row justify-between">
                    <div class="mr-[30px]">
                        <span style="font-size: 1.3em" id="tooltip_1"
                              class="cursor-default uppercase mb-[20px]">{{__('Aktivnosti')}}</span>
                        <!-- Activity Cards -->
    ...
    <div class="absolutee2">
        <div class="font-sans absolute w-full h-full flex justify-center items-center">
            <div class="w-[640px] mx-5">
                ...
                <ul>
                    <li class="mt-2 wikipedia-link"><a href="{{route('working-time')}}">{{__('Radno vrijeme')}} <i
                                class="fas fa-clock"></i></a></li>
                    <li class="mt-2 wikipedia-link"><a href="{{route('faq')}}">{{__('FAQ - Često postavljana pitanja')}}
                            <i class="fas fa-question"></i></a></li>
                    <li class="mt-2 wikipedia-link"><a target="_blank"
                                                       href="https://elektropg.online/">{{__('Sajt škole')}} <i
                                class="fas fa-school"></i></a></li>
                </ul>
            </div>
        </div>
    </div>
